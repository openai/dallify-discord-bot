// @ts-nocheck
import { Client, ButtonInteraction, ActionRowBuilder, ButtonBuilder, ButtonStyle, ComponentType, MessageComponentInteraction, IntegrationApplication } from "discord.js";
import { Action, CustomIdContext } from "../Action";
import { OPENAI_API_SIZE_ARG, openai, Buffer, imagesFromBase64Response } from "../utils/openai";
import { createResponse, processOpenAIError } from "../utils/discord";
import { fetchImagesFromComposite, actionsFromRow, rowFromActions } from "../utils/discord";
