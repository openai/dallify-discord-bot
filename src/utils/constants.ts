...
export const DISCORD_BOT_TOKEN = process.env.DISCORD_BOT_TOKEN ?? config.DISCORD_BOT_TOKEN
export const DISCORD_BOT_CLIENT_ID = process.env.DISCORD_BOT_CLIENT_ID ?? config.DISCORD_BOT_CLIENT_ID

export const OPENAI_API_KEY =  process.env.OPENAI_API_KEY ?? config.OPENAI_API_KEY
export const ALLOWED_SERVER_IDS: string[] = config.ALLOWED_SERVER_IDS ?? []; // only servers with these ids can use the bot
